    ...
    public static class SchedulerHelper {
        public static SchedulerSettings Settings {
            get {
                ...
                settings.ActiveViewType = SchedulerViewType.Month; //RenderUtils.Browser.Platform.IsMobileUI ? SchedulerViewType.Day : SchedulerViewType.WorkWeek;
                settings.Views.MonthView.CellAutoHeightOptions.MinHeight = 64;
                settings.Views.MonthView.CellAutoHeightOptions.Mode = DevExpress.Web.ASPxScheduler.AutoHeightMode.FitToContent;
                //settings.Views.MonthView.WeekCount = 52;
