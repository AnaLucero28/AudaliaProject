...
namespace WindowsApplication
{
    public partial class GanttUserControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void AddGanttTask(ProjectEmployeeAssoc projectEmployeeAssoc)
        {
            ...
            else
            {
                ...
                GanttNodes.Add(new GanttNode(GanttNodeType.Task)
                {
                    ...
                    //DBID = projectEmployeeAssoc.Project.DBID,
                    Name = projectEmployeeAssoc.Project.Name,
                        ...
                        case GanttNodeType.Project:
                            {
                                ...
                                //Primera fase
                                {
                                    ...
                                    float finish = (float)e.GetPosition(currentProject.FinishDate1.AddDays(1));
                                ...
                                //Segunda fase
                                {
                                    if (currentProject.StartDate2 != null)
                                    {
                                        ...
                                        float finish = (float)e.GetPosition(currentProject.FinishDate2.Value.AddDays(1));
                                        var shape2 = e.Info.ShapeBounds;
                                        shape2.X = start;
                                        shape2.Width = finish - start;
                                ...
                                //Tercera fase
                                {
                                    ...
                                    if (currentProject.StartDate3 != null)
                                    {
                                        ...
                                        float finish = (float)e.GetPosition(currentProject.FinishDate3.Value.AddDays(1));
                                        var shape2 = e.Info.ShapeBounds;
                                        shape2.X = start;
                                        shape2.Width = finish - start;
                        ...
                        case GanttNodeType.Task:
                            {
                                ...
                                */
                                ...
                                //Primera Fase
                                {
                                    ...
                                    float finish = (float)e.GetPosition(currentTask.FinishDate1.AddDays(1));
                                    var shape2 = e.Info.ShapeBounds;
                                    shape2.X = start;
                                    shape2.Width = finish - start;
                                ...
                                if (currentTask.StartDate2 != null)
                                {
                                    ...
                                    float finish = (float)e.GetPosition(currentTask.FinishDate2.Value.AddDays(1));
                                    var shape2 = e.Info.ShapeBounds;
                                    shape2.X = start;
                                    shape2.Width = finish - start;
                                ...
                                if (currentTask.StartDate3 != null)
                                {
                                    ...
                                    float finish = (float)e.GetPosition(currentTask.FinishDate3.Value.AddDays(1));
                                    var shape2 = e.Info.ShapeBounds;
                                    shape2.X = start;
                                    shape2.Width = finish - start;
        ...
        private void InitRibbonFilters()
        {
            ...
            for (int i = 0; i <= 6; i++)
                ejercicioComboBox.Items.Add(DateTime.Now.Year - i + 1);
        ...
        private void barButtonItem8_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //string filterString = "([StartDate] <= #" + finishDate.ToString("yyyy-MM-dd") + "# And [FinishDate] >= #" + startDate.ToString("yyyy-MM-dd") + "#)";            
            string monthString = startDate.ToString("MMMM - yyyy");
            monthBarEditItem.EditValue = monthString;
            
            
            //monthRepositoryItemComboBox.SelectedIndexChanged(); _SelectedIndexChanged(monthRepositoryItemComboBox, null);
            /*
            if (!ganttControl.ActiveFilterString.Contains(filterString))
            {
                ganttControl.ActiveFilterString += (ganttControl.ActiveFilterString != "" ? " And " : "") + filterString;
